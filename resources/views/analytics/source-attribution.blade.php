...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-orange-50 to-amber-50 py-8">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-gray-900">?ç Source Attribution Analytics</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div class="bg-white rounded-2xl shadow-lg p-6 border border-orange-100">
                <h2 class="text-xl font-bold text-gray-900 mb-4">?ä Candidates by Source</h2>
                <div class="h-80">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-orange-100">
            <h2 class="text-xl font-bold text-gray-900 mb-6">?à Conversion Rates by Source</h2>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-orange-100">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-xl font-bold text-gray-900">?ã Detailed Source Performance</h2>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-orange-100">
            <h2 class="text-xl font-bold text-gray-900 mb-6">?Ö Source Trends Over Time</h2>
            <div class="h-80">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl shadow-lg p-6 text-white">
                <div class="text-lg opacity-90 mb-2">Ü Best ROI Source</div>
            ...
            <div class="bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl shadow-lg p-6 text-white">
                <div class="text-lg opacity-90 mb-2">?à Fastest Growing</div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 border border-orange-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4" id="recommendations">
                ...
                <div class="p-4 bg-red-50 rounded-xl">
                    <div class="font-medium text-red-700">‚ö†Ô∏è Review Effectiveness</div>
