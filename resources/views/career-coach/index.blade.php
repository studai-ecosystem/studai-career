...
<div class="space-y-6">
    ...
    {{-- HERO --}}
    <div class="relative overflow-hidden rounded-2xl p-6 text-white" style="background:linear-gradient(135deg,#4c1d95 0%,#6d28d9 40%,#7c3aed 100%);">
        ...
        <div class="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <button onclick="startSession('general_advice')" class="inline-flex items-center gap-2 px-5 py-2.5 font-semibold rounded-xl transition-all shadow-sm text-sm flex-shrink-0" style="background:#fff;color:#6d28d9;">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
            <div class="w-10 h-10 rounded-xl flex items-center justify-center mb-3" style="background:#fef3c7;">
                <svg class="w-5 h-5" style="color:#d97706;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"/></svg>
            </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
            <div class="w-10 h-10 rounded-xl flex items-center justify-center mb-3" style="background:#e3f2fd;">
                <svg class="w-5 h-5" style="color:#1976d2;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 space-y-5">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                    @php $sessionTypes = [
                        'general_advice'    => ['icon'=>'&#x1F4AC;','label'=>'General Advice',   'desc'=>'Ask anything',          'bg'=>'#f5f3ff','border'=>'#ddd6fe','hbg'=>'#ede9fe'],
                        'career_planning'   => ['icon'=>'&#x1F5FA;','label'=>'Career Planning',   'desc'=>'Map your path',         'bg'=>'#e3f2fd','border'=>'#bbdefb','hbg'=>'#bbdefb'],
                        'skill_development' => ['icon'=>'&#x1F4DA;','label'=>'Skills',             'desc'=>'Level up',              'bg'=>'#dcfce7','border'=>'#bbf7d0','hbg'=>'#bbf7d0'],
                        'interview_prep'    => ['icon'=>'&#x1F3A4;','label'=>'Interview Prep',     'desc'=>'Practice &amp; prepare','bg'=>'#fce4ec','border'=>'#f8bbd0','hbg'=>'#f8bbd0'],
                    ]; @endphp
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="{{ route('career-coach.goals') }}" class="text-sm font-medium hover:underline" style="color:#7c3aed;">View All &rarr;</a>
                </div>
                @forelse($goals as $goal)
                <div class="mb-3 p-4 rounded-xl border" style="background:#f5f3ff;border-color:#ddd6fe;">
                    ...
                    <div class="mt-3">
                        <div class="flex items-center justify-between text-xs mb-1">
                            ...
                            <span class="font-semibold" style="color:#7c3aed;">{{ $goal->progress_percentage }}%</span>
                        </div>
                        <div class="h-2 rounded-full overflow-hidden" style="background:#ede9fe;">
                            <div class="h-full rounded-full skill-bar-fill transition-all duration-700" style="width:{{ $goal->progress_percentage }}%;background:#7c3aed;"></div>
                        </div>
                    </div>
                    @if($goal->target_date)
                ...
                <div class="text-center py-8">
                    <div class="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3" style="background:#ede9fe;">
                        <svg class="w-6 h-6" style="color:#a78bfa;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    </div>
                    <p class="text-sm text-gray-600">No active goals yet</p>
                    <a href="{{ route('career-coach.goals') }}" class="mt-1 text-sm hover:underline inline-block" style="color:#7c3aed;">Create your first goal &rarr;</a>
                </div>
                @endforelse
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="{{ route('career-coach.history') }}" class="text-sm font-medium hover:underline" style="color:#7c3aed;">View All &rarr;</a>
                </div>
                <div class="space-y-2">
        ...
        <div class="space-y-5">
            ...
            <div class="rounded-2xl p-5" style="background:#f5f3ff;border:1.5px solid #ddd6fe;">
                <h2 class="text-sm font-semibold mb-3 flex items-center gap-2" style="color:#4c1d95;">
                ...
                <div class="p-3 rounded-xl bg-white border border-purple-100 mb-2.5">
                    ...
                    <div class="mt-2 flex gap-2">
                        <button onclick="startCheckin({{ $checkin->id }})" class="px-3 py-1 text-xs text-white rounded-lg font-medium" style="background:#7c3aed;" onmouseover="this.style.background='#6d28d9'" onmouseout="this.style.background='#7c3aed'">Start</button>
            ...
            <div class="rounded-2xl p-5" style="background:#fffbeb;border:1.5px solid #fde68a;">
                <h2 class="text-sm font-semibold mb-3 flex items-center gap-2" style="color:#92400e;">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
                ...
                <div class="space-y-1.5">
                    ...
                    <a href="{{ route('career-coach.preferences') }}" class="flex items-center gap-3 p-3 rounded-xl transition-colors"
                       onmouseover="this.style.background='#f5f3ff'" onmouseout="this.style.background='transparent'">
                        <span class="w-8 h-8 rounded-lg flex items-center justify-center text-sm flex-shrink-0" style="background:#f3f4f6;">&#x2699;&#xFE0F;</span>
                    ...
                    <a href="{{ route('career-coach.history') }}" class="flex items-center gap-3 p-3 rounded-xl transition-colors"
                       onmouseover="this.style.background='#f5f3ff'" onmouseout="this.style.background='transparent'">
                        <span class="w-8 h-8 rounded-lg flex items-center justify-center text-sm flex-shrink-0" style="background:#f3f4f6;">&#x1F4DC;</span>
