...
@section('content')
{{-- Hero Section --}}
<section class="relative overflow-hidden" style="background:#EBF2FF; border-bottom:1px solid rgba(20, 71, 186,.12);">
    {{-- Orbs --}}
    <div class="absolute inset-0 pointer-events-none overflow-hidden">
        <div class="absolute" style="width:500px;height:500px;top:-120px;right:-80px;border-radius:50%;background:rgba(20, 71, 186,.22);filter:blur(60px);"></div>
        <div class="absolute" style="width:400px;height:400px;bottom:-80px;left:-60px;border-radius:50%;background:rgba(20, 71, 186,.18);filter:blur(60px);"></div>
        <div class="absolute" style="width:300px;height:300px;top:40%;left:45%;border-radius:50%;background:rgba(15, 107, 49,.14);filter:blur(50px);"></div>
    ...
    <div class="relative mx-auto max-w-7xl px-6 py-24 lg:py-32 text-center">
        ...
        <h1 class="text-4xl font-bold sm:text-5xl lg:text-6xl max-w-4xl mx-auto" style="color:#0C0C0C;line-height:1.15;">
            Hire Smarter. Hire Faster. <span style="background:#2D6CDF;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">Hire Better.</span>
        </h1>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center mt-10" style="gap:1rem;">
            ...
            <a href="#features" class="inline-flex items-center px-8 py-3.5 rounded-xl text-sm font-semibold" style="background:rgba(255,255,255,.8);color:#2D6CDF;border:1.5px solid rgba(20, 71, 186,.25);backdrop-filter:blur(8px);">
                See How It Works
            </a>
        </div>
    </div>
...
<section id="features" class="py-20 bg-surface-50">
    <div class="mx-auto max-w-7xl px-6">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-2xl p-8 border border-gray-100" style="box-shadow: none;">
...
{{-- CTA Section --}}
<section style="background:#EBF2FF; border-top:1px solid #EBF2FF;" class="py-20">
    <div class="mx-auto max-w-4xl px-6 text-center">
        <h2 class="text-3xl font-bold sm:text-4xl" style="color:#0C0C0C;">Ready to Transform Your Hiring?</h2>
        <p class="mt-4 text-lg" style="color:#3D3D3D;">
        ...
        <div class="mt-8 flex flex-col sm:flex-row items-center justify-center" style="gap:1rem;">
            <a href="{{ route('register') }}" class="inline-flex items-center px-8 py-3 rounded-xl text-sm font-semibold text-white" style="background:#2D6CDF;">
                Start Free Trial
            </a>
            <a href="{{ route('contact') }}" class="inline-flex items-center px-8 py-3 rounded-xl text-sm font-semibold" style="background:#fff; color:#2D6CDF; border:1.5px solid #EBF2FF;">
                Contact Sales
            </a>
        </div>
    </div>
