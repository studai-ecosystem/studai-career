...
@section('title', 'My Contracts - Freelancer')
@section('content')
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex gap-2 mb-6 overflow-x-auto">
            @foreach(['All' => '', 'Active' => 'active', 'Pending' => 'pending', 'Completed' => 'completed', 'Cancelled' => 'cancelled'] as $label => $val)
                <a href="{{ route('marketplace.freelancer.contracts', $val ? ['status' => $val] : []) }}"
        ...
        <div class="space-y-4">
                    ...
                    @if($contract->milestones && $contract->milestones->count())
                        <div class="mt-4">
                            <div class="flex items-center justify-between text-xs text-gray-500 mb-1">
                                ...
                                <span>{{ $contract->milestones->where('status', 'approved')->count() }} / {{ $contract->milestones->count() }} completed</span>
                            </div>
            ...
            @empty
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-12 text-center">
                    ...
                    <p class="text-gray-500 mb-4">Win a project and your contracts will appear here.</p>
