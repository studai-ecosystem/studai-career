        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
                ...
                <div class="col-span-1">
                    <div class="flex items-center gap-2.5 mb-4">
                        <img src="/assets/logo/icon.png?v=3" alt="StudAI One" style="height:28px;width:auto;object-fit:contain;flex-shrink:0">
                        <span class="text-base font-extrabold tracking-tight" style="color:#0C0C0C">Stud<span style="color:#2D6CDF">AI</span> One</span>
                    </div>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center gap-4 pt-8" style="border-top:1px solid #E2E2E0">
                <p class="text-xs" style="color:#A8A8A8">
                    &copy; {{ date('Y') }} <strong class="grad-text">StudAI One</strong>. All rights reserved. Powered by <span style="color:#2D6CDF">Orin™ AI</span>.
                </p>
