    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:flex items-center gap-8">
                ...
                <a href="{{ route('pricing') }}" class="text-sm font-medium {{ request()->routeIs('pricing') ? 'text-[#2D6CDF]' : 'text-gray-600 hover:text-gray-900' }} transition-colors">Pricing</a>
            ...
            <div class="flex items-center gap-3">
                @auth
                    <a href="{{ route('dashboard') }}" class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-[#2D6CDF] rounded-lg hover:bg-[#1B57C4] transition-colors">
                        Dashboard
                    </a>
                @else
                    ...
                    <a href="{{ route('register') }}" class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-[#2D6CDF] rounded-lg hover:bg-[#1B57C4] transition-colors">
                        Start Free
                    </a>
                @endauth
            </div>
